...
/***/ function(module, exports, __webpack_require__) {
	...
	var Page = function () {
	    function Page(options) {
	        ...
	        this._gallery = new _gallery2.default({
	            elem: document.querySelector('[data-component=gallery]'),
	            item: null
	        });
	
	        this._carousel = new _carousel2.default({
	        ...
	        this._menu.getElement().addEventListener('itemSelected', this._onMenuItemSelected.bind(this));
	        this._carousel.getElement().addEventListener('imageSelected', this._onImageChange.bind(this));
	        this._carousel.getElement().addEventListener('arroqClick', this._onArrowClick.bind(this));
	    }
	    ...
	    _createClass(Page, [{
	        ...
	        key: '_onMenuItemSelected',
	        value: function _onMenuItemSelected(event) {
	            this._loadPhoneData(event.detail.phoneId);
	        }
	    }, {
	        key: '_loadPhoneData',
	        value: function _loadPhoneData(phoneId) {
	            var xhr = new XMLHttpRequest();
	        ...
	        key: '_phoneDataLoaded',
	        value: function _phoneDataLoaded(event) {
	        ...
	        key: '_onImageChange',
	        value: function _onImageChange(event) {
	            this._gallery.changePicture(event.detail.src, event.detail.alt);
	        }
	    }, {
	        key: '_onArrowClick',
	        value: function _onArrowClick(event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Menu = function () {
	    ...
	    _createClass(Menu, [{
	        ...
	        key: 'filteringItems',
	        value: function filteringItems(searchValue) {
	        ...
	        key: '_renderItems',
	        value: function _renderItems(currentItems) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Search = function () {
	    ...
	    _createClass(Search, [{
	        ...
	        key: '_onSearchInput',
	        value: function _onSearchInput(event) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Gallery = function () {
	    ...
	    _createClass(Gallery, [{
	        ...
	        key: 'setGalleryItems',
	        value: function setGalleryItems(item) {
	            this._item = item;
	            this._render();
	        }
	    }, {
	        key: 'changePicture',
	        value: function changePicture(src, alt) {
	        ...
	        key: '_render',
	        value: function _render() {
	            this._el.innerHTML = this._galleryLargeImgTemplateFunction({ item: '../Data/' + this._item, title: "Image " + this._item.slice(-5, -4) });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Carousel = function () {
	    ...
	    _createClass(Carousel, [{
	        ...
	        value: function setCarouselItems(items) {
	            this._items = items;
	            this._render();
	        }
	    }, {
	        ...
	        key: 'changePicture',
	        value: function changePicture(img, src, alt) {
	            img.src = src;
	            img.alt = alt;
	        }
	    }, {
	        key: 'moveImages',
	        value: function moveImages(arrow) {
	            ...
	            var newPositionImages = arrow.id === 'arrow-left' ? this._left(positionImages, widthImage, amountMoveImages) : this._right(positionImages, widthImage, amountMoveImages);
	        ...
	        value: function _render() {
	            ...
	            this._items.forEach(function (item) {
	                container.insertAdjacentHTML('beforeEnd', this._carouselItemsTemplateFunction({ item: '../Data/' + item,
	        ...
	        key: '_leftMoveImages',
	        value: function _leftMoveImages(position, width, amount) {
	            return Math.min(position + amount * width, 0);
	        }
	    }, {
	        key: '_rightMoveImages',
	        value: function _rightMoveImages(position, width, amount) {
	            return Math.max(position - amount * width, -width * (this._items.length - 4));
	        }
	    }, {
	        key: '_changeBorderSelectedImage',
	        value: function _changeBorderSelectedImage(target) {
